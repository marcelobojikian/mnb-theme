...
class ComponentFactory {
	 ...
	 */	
	public RecalboxCarousel createCarousel(String name) {
		return builder.createElement(RecalboxCarousel.class, name);
	}
	
	public RecalboxCarousel createCarousel(String name, boolean extra) {
		return builder.createElement(RecalboxCarousel.class, name, extra);
	}
	
	public RecalboxCarousel createCarousel(String name, Map<String, String> attributes) {
		return builder.createElement(RecalboxCarousel.class, name, attributes);
	}
	
	public RecalboxCarousel createCarousel(String name, boolean extra, Map<String, String> attributes) {
		return builder.createElement(RecalboxCarousel.class, name, attributes);
	}
